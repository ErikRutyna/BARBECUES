...
class UnstructuredMesh:
    ...
    def __init__(self, sim):
        # Self-link the sim to the mesh for data access
        self.simulation = sim

        # Placeholder to get linked later once the flowfield exists
        self.unstructuredFlowfield = None

        # Begin loading in and generating the mesh object itself
        filepath = self.simulation.config['project'][0]['mesh_path']
