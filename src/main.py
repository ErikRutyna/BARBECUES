...
def main():
    ...
    plotmesh.plot_mach(mesh, state_variables, op_con, 'inlet_{0}_M{1}_a{2}_m_solved.png'
                       .format(op_con.flux_method, op_con.M, op_con.a))
    plotmesh.plot_stagnation_pressure(mesh, state_variables, op_con, 'inlet_{0}_M{1}_a{2}_p0_solved.png'
                       .format(op_con.flux_method, op_con.M, op_con.a))
